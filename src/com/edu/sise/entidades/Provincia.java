...
public class Provincia {
    ...
    //atributo para descripcion del departamento       
    private String desc_id_depa;
    ...
    public Provincia(Integer id_prov, String nombre, Integer id_depa, String desc_id_depa) {
        this.id_prov = id_prov;
        this.nombre = nombre;
        this.id_depa = id_depa;
        this.desc_id_depa = desc_id_depa;
    }
    ...
    public String getDesc_id_depa() {
        return desc_id_depa;
    }

    public void setDesc_id_depa(String desc_id_depa) {
        this.desc_id_depa = desc_id_depa;
    }
